...
```bash
npm i @duxor/ngx-custom-validators --save
```
...
import { CustomFormsModule } from '@duxor/ngx-custom-validators';
...
import { CustomValidators } from '@duxor/ngx-custom-validators';
